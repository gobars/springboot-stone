...
结论，在 192.158.136.140 机器 alliance-http-server 服务，单修改 GC 性能提升 100%

用于和 coss 代码对比

1. spring boot QPS 可以到 7 W +，最高达到过 7.45 W，CPU 占用约 1000%
2. 脚手架空工程可以达到 7 W +,略低于 spring boot 原始，CPU 占用约 1000%
3. coss 默认可以达到 2.4W，CPU 占用小于 800%
4. coss G1GC 可以达到 4.8W，CPU 占用约 1000%
